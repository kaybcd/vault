  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white p-8 md:p-16">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12">
          ...
          <button className="bg-white text-black px-8 py-4 rounded-[40px] font-bold hover:bg-emerald-400 transition-all transform hover:scale-105">
            Invest Now
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <div className="bg-red p-8 rounded-[40px] border border-slate-800 overflow-hidden">
          ...
          <div className="bg-[#111] p-8 rounded-2xl border border-slate-800">
    ...
    <div className="bg-[#0a0a0a] rounded-3xl border border-slate-800 p-6 overflow-x-auto">
        ...
        <tbody className="font-mono text-sm">
            {years.map(year => {
            // Calculate the Annual Total for this specific year
            const yearlyValues = Object.values(matrix[year]);
            const annualTotal = yearlyValues.reduce((acc, curr) => acc + curr, 0);
